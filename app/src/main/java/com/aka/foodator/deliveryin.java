...
public class deliveryin extends AppCompatActivity implements
    ...
    AutoCompleteTextView restaurant;
    Button b;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        restaurant = (AutoCompleteTextView) findViewById(R.id.autotext_restaurants);


        mGoogleApiClient = new GoogleApiClient.Builder(deliveryin.this)
        ...
        restaurant.setTypeface(face);
        auto_cities.setTypeface(face);
        b.setTypeface(face);
